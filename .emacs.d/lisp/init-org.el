...
(setq org-tag-alist '(("work" . ?w) ("private" . ?p) ("study" . ?s) ("birthday" . ?b) ("training" . ?t) ("reading" . ?r) ("vacation" . ?v) ("fun" . ?f) ("games" . ?g) ("programming")))

(setq org-agenda-files (list "~/git/org/inbox/frompersonal.org"
                             "~/git/org/inbox/fromwork.org"
                             "~/git/org/inbox/fromuniversity.org"
